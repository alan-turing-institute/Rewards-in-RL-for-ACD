...
## Set the log_initial level by value or name.
#  Choices: any of [0, 10, 20, 30, 40, 50, 'DEBUG', 'INFO', 'WARN', 'ERROR', 'CRITICAL']
#  Default: 30
# c.Application.log_level = 30

## Configure additional log_initial handlers.
#
#  The default stderr logs handler is configured by the log_level, log_datefmt
#  and log_format settings.
#
#  This configuration can be used to configure additional handlers (e.g. to
#  output the log_initial to a file) or for finer control over the default handlers.
#
...
#
#          Some anonymous compute images still desire the ability to run code,
...
## The gateway API endpoint for accessing kernel images
...
## The gateway endpoint for accessing kernelspecs images
