...
| `src/yawning_titan/envs/generic/core/reward_functions.py` | Added the reward functions studied in the paper: `simple_positive`, `simple_negative`, `simple_pos_neg`, `dense_negative`, `complex_dense_negative`, `dense_positive`, and a set of `simple_positive_ablation_*` variants. These are the central experimental variables. |
