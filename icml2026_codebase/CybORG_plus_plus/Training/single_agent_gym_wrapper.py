...
# Add .../icml2026_codebase to sys.path
ROOT = Path(__file__).resolve().parents[2]   # up from Training -> CybORG_plus_plus -> icml2026_codebase
...
class MiniCageBlue(gym.Env):
    ...
    Red is driven by a scripted opponent (B-line).
    """
